...
namespace DigitalRuby.ThunderAndLightning
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        [Header("JitterMultiplier: 控制雷电抖动的幅度。数值越高，雷电的抖动越明显。")]
        ...
        [Header("Turbulence: 控制雷电路径的混乱程度。值越高，路径越不规则。")]
        ...
        [Header("TurbulenceVelocity: 指定雷电路径混乱的速度方向。")]
        ...
        [Header("IntensityFlicker: 控制雷电强度的闪烁范围.X: 最小闪烁值。Y: 最大闪烁值。")]
...
#region Private methods
        ...
        {
            Camera = (Camera == null ? (Camera.current == null ? CameraController.Instance.MainCamera : Camera.main) : Camera);
        }
