...
namespace DigitalRuby.ThunderAndLightning
{
    ...
    public abstract class LightningBoltPrefabScriptBase : LightningBoltScript
    {
        ...
        [Header("Interval Range ： 控制雷电生成的时间间隔范围（最小/最大间隔）。")]
        ...
        [Header("Count Range ： 控制每次生成雷电的数量范围。")]
        ...
        [Range(0.0f, 1.0f)]
        [Header("Count Probability Modifier ：调整生成雷电数量的概率分布。")]
        ...
        [Header("Delay Range (Min/Max) 控制每次雷电生成的延迟范围。")]
        ...
        [Header("Duration Range (Min/Max) 雷电持续时间的范围（短暂闪电 vs 长时间雷光）。")]
        ...
        [Header("Trunk Width Range (Min/Max) 控制雷电主干的宽度范围。")]
        ...
        [Range(1, 8)]
        [Header("Generations 控制雷电的分支代数。更多代数会产生更复杂的分支结构。")]
        ...
        [Range(0.0f, 1.0f)]
        [Header("Chaos Factor 决定雷电路径的混乱程度。")]
        ...
        [Range(0.0f, 64.0f)]
        [Header("Glow Width Multiplier 调整发光效果的宽度倍增。")]
        ...
        [Range(0.0f, 0.5f)]
        [Header("Fade Percent 控制雷电的渐隐百分比。")]
        ...
        [Range(0.0f, 1.0f)]
        [Header("Fade In Multiplier 控制雷电渐入的速度。")]
        ...
        [Range(0.0f, 1.0f)]
        [Header("Fade Fully Lit Multiplier 控制雷电完全点亮的时间比例。")]
        ...
        [Range(0.0f, 1.0f)]
        [Header("Fade Out Multiplier控制雷电渐出的速度。")]
        ...
        [Range(0.0f, 1.0f)]
        [Header("Growth Multiplier 控制雷电的增长速度。")]
        ...
        [Range(0.0f, 10.0f)]
        [Header("End Width Multiplier 调整雷电尾部宽度相对于主干的比例。")]
        ...
        [Header("Fork Length Multiplier 决定雷电分支长度的倍增值。")]
        ...
        [Header("Fork Length Variance 调整分支长度的随机性。")]
        ...
        [Range(0.0f, 10.0f)]
        [Header("Fork End Width Multiplier 控制分支尾部宽度相对于主干的比例。")]
